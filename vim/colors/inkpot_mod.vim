...
exec "hi Normal         cterm=NONE   ctermfg=" . <SID>X(7) . " ctermbg=" . "NONE" 
...
exec "hi StatusLine     cterm=BOLD   ctermfg=" . <SID>X(85) . " ctermbg=" . <SID>X(82)
...
exec "hi Number         cterm=NONE   ctermfg=" . <SID>X(75) " ctermbg=" . "NONE"
...
exec "hi Type           cterm=NONE   ctermfg=" . <SID>X(69) . " ctermbg=" . "NONE"
