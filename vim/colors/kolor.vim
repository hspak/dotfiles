...
if &t_Co > 255
  highlight Normal          ctermfg=111     ctermbg=235     cterm=none
  highlight SpecialKey      ctermfg=111     ctermbg=none    cterm=none
  highlight NonText         ctermfg=111     ctermbg=235     cterm=none
  highlight Directory       ctermfg=111     ctermbg=none    cterm=none
  highlight IncSearch       ctermfg=111       ctermbg=206     cterm=none
  highlight LineNr          ctermfg=111     ctermbg=234     cterm=none
  highlight StatusLine      ctermfg=111       ctermbg=247     cterm=none
  highlight StatusLineNC    ctermfg=111     ctermbg=238     cterm=none
